...
//                    break;
               ...
               // }
                break;
            case "Create":
                System.out.println("sdfdsfdsfsdfsdfsdfdsfsdfdsf");
                String newusername = request.getParameter("user");
                
                String newpassword = request.getParameter("psw");
                String Buy_sell = request.getParameter("Buy_sell");
                adduser(newusername, newpassword, Buy_sell, token);
                request.setAttribute("create", token);
            ...
            case "CreateAccount":
                System.out.println("Hello Wordlddsd");
    ...
    private PropertyXML retreiveServicesFromBackend(String query, String token) {
        try {
    ...
    private void adduser(String username, String password, String Buy_sell, String token) {
        try {
            Business.updateUsers(username, password, Buy_sell, token);
        } catch (Exception ex) {
